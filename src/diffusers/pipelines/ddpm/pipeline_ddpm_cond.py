# This was an added script by Randy Chase and Alex Rybchuk 
#
# Last edits were made on 30 Jan 2024. 
#
# We needed to parse the original code to work for our examples in the Earth Sciences
# The main things changed were this script, then the __init__ files to make it pass the classes up. 
# 
# This script is basically a copy of pipeline_ddpm.py with some minor changes. 
...
class DDPMCondPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        for t in self.progress_bar(self.scheduler.timesteps):
            ...
            model_output = self.unet(image, t, conditioning).sample
